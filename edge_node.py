...
class EdgeNode():
    def __init__(self):
        ...
        self.hash2_manager_thread = threading.Thread(target=self.hash2_manager, name="hash2_manager_thread", daemon=True)
                ...
                if eth_response is not None:
                    ...
                    for index in waiting_indexes:
                        ...
                        if log_entry:
                            ...
                            self.analyser.history[index].hash2_receive_timestamp = time.perf_counter()
